...
<template>
  <section class="transaction" aria-label="거래 내역">
      ...
      >
        ...
        <div class="transaction-day__header">
          <div class="transaction-day__date-wrap">
            <span class="transaction-day__year">{{ formatYear(group.date) }}</span>
        ...
        <ul class="transaction-list">
          ...
          >
            <!-- 좌: 카테고리 아이콘 -->
            <div class="transaction-item__avatar" :class="`transaction-item__avatar--${tx.type}`">
              <span class="transaction-item__avatar-letter">{{ categoryInitial(tx.category) }}</span>
            </div>
            ...
            <div class="transaction-item__content">
              <div class="transaction-item__top-row">
                ...
                <span class="transaction-type-badge transaction-type-badge--{{ tx.type }}">{{ typeLabel(tx.type) }}</span>
              </div>
            ...
            <div class="transaction-item__right">
              <span class="transaction-amount" :class="`transaction-amount--${tx.type}`">
    ...
    <div v-else class="transaction-empty">
      <svg class="transaction-empty__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
